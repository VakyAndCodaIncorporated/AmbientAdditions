...
public class CardiganCorgiCollarLayer extends GeoLayerRenderer<CardiganCorgi> {
   ...
   public CardiganCorgiCollarLayer(IGeoRenderer<CardiganCorgi> entityRendererIn) {
      super(entityRendererIn);
   }

   @Override
   public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLightIn, CardiganCorgi animatable, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
