...
public class PembrokeCorgiCollarLayer extends GeoRenderLayer<PembrokeCorgi> {
   ...
   public PembrokeCorgiCollarLayer(GeoRenderer<PembrokeCorgi> entityRendererIn) {
      super(entityRendererIn);
   }

   @Override
   public void render(PoseStack poseStack, PembrokeCorgi animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
