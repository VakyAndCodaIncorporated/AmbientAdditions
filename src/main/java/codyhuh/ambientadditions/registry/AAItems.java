...
public class AAItems {
    ...
    public static final RegistryObject<Item> YETI_CRAB_BUCKET = ITEMS.register("yeti_crab_bucket", () -> new MobBucketItem(AAEntities.YETI_CRAB, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().tab(TAB).stacksTo(1)));
