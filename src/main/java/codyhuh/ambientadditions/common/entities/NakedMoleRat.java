...
public class NakedMoleRat extends Animal implements IAnimatable {

    public NakedMoleRat(EntityType<? extends Animal> p_i48568_1_, Level p_i48568_2_) {
    ...
    @Nullable
    @Override
    public NakedMoleRat getBreedOffspring(ServerLevel world, AgeableMob animal) {
