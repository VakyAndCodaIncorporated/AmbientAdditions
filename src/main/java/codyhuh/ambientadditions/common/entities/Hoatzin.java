...
public class Hoatzin extends ShoulderRidingEntity implements FlyingAnimal, IAnimatable {
    public float flap;
    ...
    public Hoatzin(EntityType<? extends Hoatzin> p_i50251_1_, Level p_i50251_2_) {
    ...
    public static boolean checkHoatzinSpawnRules(EntityType<Hoatzin> p_223317_0_, LevelAccessor p_223317_1_, MobSpawnType p_223317_2_, BlockPos p_223317_3_, Random p_223317_4_) {
