...
public class StagBeetle extends PathfinderMob implements IAnimatable {

    public StagBeetle(EntityType<? extends PathfinderMob> type, Level world) {
        super(type, world);
    }
    ...
    private void saveToBucketTag(ItemStack p_204211_1_) {
