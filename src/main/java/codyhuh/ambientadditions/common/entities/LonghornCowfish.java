...
public class LonghornCowfish extends AbstractFish implements IAnimatable, IFlopper {

    public LonghornCowfish(EntityType<? extends AbstractFish> p_i48855_1_, Level p_i48855_2_) {
