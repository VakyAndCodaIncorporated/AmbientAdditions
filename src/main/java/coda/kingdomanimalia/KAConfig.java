...
@Mod.EventBusSubscriber(modid = KingdomAnimalia.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class KAConfig {
    ...
    public static void configLoad(ModConfigEvent.Reloading event) {
        try {
            ...
            KingdomAnimalia.LOGGER.error("Something went wrong updating the Ambient Additions config, using previous or default values! {}", e.toString());
        }
    }
    ...
    public static class Common {
        ...
        public static void reload() {
            KAConfig.whiteFruitBatSpawnWeight = INSTANCE.whiteFruitBatSpawnWeight.get();
            KAConfig.moustachedTamarinSpawnWeight = INSTANCE.moustachedTamarinSpawnWeight.get();
            KAConfig.scarletHoneycreeperSpawnWeight = INSTANCE.scarletHoneycreeperSpawnWeight.get();
            KAConfig.pinocchioAnoleSpawnWeight = INSTANCE.pinocchioAnoleSpawnWeight.get();
            KAConfig.ayeAyeSpawnWeight = INSTANCE.ayeAyeSpawnWeight.get();
            KAConfig.siamangGibbonSpawnWeight = INSTANCE.siamangGibbonSpawnWeight.get();
            KAConfig.ringTailedLemurSpawnWeight = INSTANCE.ringTailedLemurSpawnWeight.get();
            KAConfig.statBeetleSpawnWeight = INSTANCE.statBeetleSpawnWeight.get();
            KAConfig.pineMartenSpawnWeight = INSTANCE.pineMartenSpawnWeight.get();
            KAConfig.nineBandedArmadilloSpawnWeight = INSTANCE.nineBandedArmadilloSpawnWeight.get();
            KAConfig.leafFrogSpawnWeight = INSTANCE.leafFrogSpawnWeight.get();
            KAConfig.pinkFairyArmadilloSpawnWeight = INSTANCE.pinkFairyArmadilloSpawnWeight.get();
            KAConfig.spiderTailedAdderSpawnWeight = INSTANCE.spiderTailedAdderSpawnWeight.get();
            KAConfig.moleSpawnWeight = INSTANCE.moleSpawnWeight.get();
            KAConfig.pembrokeCorgiSpawnWeight = INSTANCE.pembrokeCorgiSpawnWeight.get();
            KAConfig.nakedMoleRatSpawnWeight = INSTANCE.nakedMoleRatSpawnWeight.get();
            KAConfig.veiledChameleonSpawnWeight = INSTANCE.veiledChameleonSpawnWeight.get();
            KAConfig.giantLandSnailSpawnWeight = INSTANCE.giantLandSnailSpawnWeight.get();
            KAConfig.cardiganCorgiSpawnWeight = INSTANCE.cardiganCorgiSpawnWeight.get();
            KAConfig.longhornCowfishSpawnWeight = INSTANCE.longhornCowfishSpawnWeight.get();
            KAConfig.napoleonWrasseSpawnWeight = INSTANCE.napoleonWrasseSpawnWeight.get();
            KAConfig.chocolateChipStarfishSpawnWeight = INSTANCE.chocolateChipStarfishSpawnWeight.get();
            KAConfig.harlequinShrimpSpawnWeight = INSTANCE.harlequinShrimpSpawnWeight.get();
            KAConfig.shameFacedCrabSpawnWeight = INSTANCE.shameFacedCrabSpawnWeight.get();
            KAConfig.yetiCrabSpawnWeight = INSTANCE.yetiCrabSpawnWeight.get();
            KAConfig.rubberDuckyIsopodSpawnWeight = INSTANCE.rubberDuckyIsopodSpawnWeight.get();
            KAConfig.cardiganCorgiMansionSpawnWeight = INSTANCE.cardiganCorgiMansionSpawnWeight.get();
            KAConfig.rabbitSnailSpawnWeight = INSTANCE.rabbitSnailSpawnWeight.get();
        }
    }
}