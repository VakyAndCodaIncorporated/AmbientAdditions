...
public class BlowgunItem extends ProjectileWeaponItem {
    public static final Predicate<ItemStack> DART_ONLY = (p_220002_0_) -> p_220002_0_.getItem() == (KAItems.DART.get());
        ...
        if (p_77615_3_ instanceof Player) {
            ...
            if (!itemstack.isEmpty() || flag) {
                if (itemstack.isEmpty()) {
                    itemstack = new ItemStack(KAItems.DART.get());
                }
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!p_77615_2_.isClientSide) {
                        DartItem arrowitem = (DartItem)(itemstack.getItem() instanceof DartItem ? itemstack.getItem() : KAItems.DART.get());
