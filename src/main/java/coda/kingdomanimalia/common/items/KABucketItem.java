...
public class KABucketItem extends BucketItem {
    private final Supplier<? extends Fluid> fluid;

    public KABucketItem(Supplier<? extends EntityType<?>> entityType, Supplier<? extends Fluid> fluid, Properties builder) {
        super(fluid, builder);
        this.fluid = fluid;
