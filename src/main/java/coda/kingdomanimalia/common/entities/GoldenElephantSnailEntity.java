...
public class GoldenElephantSnailEntity extends WaterAnimal implements IAnimatable {
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(KAItems.GOLDEN_ELEPHANT_SNAIL_SPAWN_EGG.get());
    }

    public static boolean checkSnailSpawnRules(EntityType<? extends GoldenElephantSnailEntity> p_223363_0_, LevelAccessor p_223363_1_, MobSpawnType p_223363_2_, BlockPos p_223363_3_, RandomSource p_223363_4_) {
