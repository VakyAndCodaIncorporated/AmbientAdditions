...
public class NineBandedArmadilloEntity extends Animal implements IAnimatable {
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(KAItems.NINE_BANDED_ARMADILLO_SPAWN_EGG.get());
    }

    @Nullable
    @Override
    protected SoundEvent getAmbientSound() {
        return KASounds.ARMADILLO_AMBIENT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getHurtSound(DamageSource p_184601_1_) {
        return KASounds.ARMADILLO_HURT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return KASounds.ARMADILLO_DEATH.get();
    }
...
*/
    ...
    public NineBandedArmadilloEntity getBreedOffspring(ServerLevel world, AgeableMob animal) {
        return KAEntities.NINE_BANDED_ARMADILLO.get().create(world);
    }
