package coda.kingdomanimalia.common.entities.ai.goal;
...
public class MoleDiggingGoal extends Goal {
    private static final ResourceLocation DIGGING_LOOT = new ResourceLocation(KingdomAnimalia.MOD_ID, "gameplay/mole_digging");
