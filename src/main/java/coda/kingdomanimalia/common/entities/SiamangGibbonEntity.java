...
public class SiamangGibbonEntity extends Animal implements IAnimatable {
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return KASounds.SIAMANG_HURT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return KASounds.SIAMANG_DEATH.get();
    }

    @Nullable
    @Override
    protected SoundEvent getAmbientSound() {
        return KASounds.SIAMANG_AMBIENT.get();
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        return KAEntities.SIAMANG_GIBBON.get().create(p_241840_1_);
    }
    ...
    public void aiStep() {
        ...
        if (dayTime == 23500) {
            playSound(KASounds.SIAMANG_BOOMING.get(), 0.6F,  1.0F);
        }
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(KAItems.SIAMANG_GIBBON_SPAWN_EGG.get());
    }
}
