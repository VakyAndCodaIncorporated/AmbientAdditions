...
public class YetiCrabEntity extends WaterAnimal implements IAnimatable {
    ...
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(YetiCrabEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> SHEARED = SynchedEntityData.defineId(YetiCrabEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    protected ItemStack getFishBucket() {
        return new ItemStack(KAItems.YETI_CRAB_BUCKET.get());
    }
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(KAItems.YETI_CRAB_SPAWN_EGG.get());
    }
    ...
    protected InteractionResult mobInteract(Player p_230254_1_, InteractionHand p_230254_2_) {
        ...
        if (itemstack.getItem() == Items.WATER_BUCKET && this.isAlive()) {
            ...
            spawnAtLocation(new ItemStack(KAItems.YETI_CRAB_FLUFF.get(), random.nextInt(2) + 1), 1);
