...
import coda.kingdomanimalia.common.entities.ai.goal.MoleDiggingGoal;
...
public class MoleEntity extends Animal implements IAnimatable {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25D, Ingredient.of(KAItems.WORM.get()), false));
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(KAItems.MOLE_SPAWN_EGG.get());
    }
    ...
    public boolean isFood(ItemStack p_70877_1_) {
        return p_70877_1_.getItem() == KAItems.WORM.get();
    }

    @Nullable
    @Override
    public MoleEntity getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        MoleEntity mole = KAEntities.MOLE.get().create(p_241840_1_);
    ...
    public InteractionResult mobInteract(Player p_230254_1_, InteractionHand p_230254_2_) {
        ...
        if (itemstack.getItem() == Items.BUCKET && this.isAlive()) {
            ...
            itemstack.shrink(1);
            ItemStack itemstack1 = new ItemStack(KAItems.MOLE_BUCKET.get());
