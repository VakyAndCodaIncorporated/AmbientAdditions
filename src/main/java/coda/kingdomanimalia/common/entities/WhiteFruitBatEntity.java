...
public class WhiteFruitBatEntity extends Animal implements FlyingAnimal, IAnimatable {
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(KAItems.WHITE_FRUIT_BAT_SPAWN_EGG.get());
    }

    public static boolean checkBatSpawnRules(EntityType<? extends Animal> p_223316_0_, LevelAccessor p_223316_1_, MobSpawnType p_223316_2_, BlockPos p_223316_3_, RandomSource p_223316_4_) {
