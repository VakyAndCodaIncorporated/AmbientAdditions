...
public class VeiledChameleonEntity extends Animal implements IAnimatable {
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(KAItems.VEILED_CHAMELEON_SPAWN_EGG.get());
    }
    ...
    public VeiledChameleonEntity getBreedOffspring(ServerLevel world, AgeableMob animal) {
        VeiledChameleonEntity chameleon = KAEntities.VEILED_CHAMELEON.get().create(world);
