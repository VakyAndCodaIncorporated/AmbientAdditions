...
public class AyeAyeEntity extends Animal implements IAnimatable {
    ...
    private static final Ingredient TEMPTATION_ITEMS = Ingredient.of(KAItems.WORM.get());

    public AyeAyeEntity(EntityType<? extends Animal> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        return KAEntities.AYE_AYE.get().create(p_241840_1_);
    }

    @Override
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(KAItems.AYE_AYE_SPAWN_EGG.get());
    }
}
