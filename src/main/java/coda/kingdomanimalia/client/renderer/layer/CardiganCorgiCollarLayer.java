...
public class CardiganCorgiCollarLayer extends GeoLayerRenderer<CardiganCorgiEntity> {
   private static final ResourceLocation COLLAR_LOCATION = new ResourceLocation(KingdomAnimalia.MOD_ID, "textures/entity/corgi/collar.png");
   private static final ResourceLocation MODEL = new ResourceLocation(KingdomAnimalia.MOD_ID, "geo/corgi.geo.json");
