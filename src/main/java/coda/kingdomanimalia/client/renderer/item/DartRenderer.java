package coda.kingdomanimalia.client.renderer.item;
...
public class DartRenderer extends EntityRenderer<DartEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(KingdomAnimalia.MOD_ID, "textures/entity/item/dart.png");
