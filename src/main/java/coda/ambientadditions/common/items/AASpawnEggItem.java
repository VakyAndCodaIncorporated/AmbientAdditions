...
public class AASpawnEggItem extends SpawnEggItem {
    public static final List<AASpawnEggItem> UNADDED_EGGS = new ArrayList<AASpawnEggItem>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public AASpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColor, final int secondaryColor, final Properties properties) {
