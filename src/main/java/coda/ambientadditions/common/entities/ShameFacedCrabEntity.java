...
public class ShameFacedCrabEntity extends WaterMobEntity {
    private static final DataParameter<Boolean> FROM_BUCKET = EntityDataManager.defineId(ShameFacedCrabEntity.class, DataSerializers.BOOLEAN);

    public ShameFacedCrabEntity(EntityType<? extends WaterMobEntity> type, World world) {
        super(type, world);
    ...
    public static AttributeModifierMap.MutableAttribute createAttributes() {
        return MobEntity.createMobAttributes().add(Attributes.MAX_HEALTH, 6).add(Attributes.MOVEMENT_SPEED, 0.15D).add(Attributes.ATTACK_DAMAGE, 1.0D);
    }
