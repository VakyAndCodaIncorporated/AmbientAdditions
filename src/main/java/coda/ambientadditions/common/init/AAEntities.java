...
public class AAEntities {
    ...
    public static final RegistryObject<EntityType<OpahEntity>> OPAH = create("shame_faced_crab", EntityType.Builder.of(OpahEntity::new, MobCategory.WATER_CREATURE).sized(0.7f, 0.85f));
