...
public class AAItems {
    ...
    public static final RegistryObject<Item> FLYING_FISH = REGISTER.register("flying_fish", () -> new Item(new Item.Properties().tab(GROUP).food(new Food.Builder().nutrition(2).saturationMod(0.1F).build())));
    ...
    public static final RegistryObject<Item> GUINEA_CHICKEN_SPAWN_EGG = REGISTER.register("guinea_chicken_spawn_egg", () -> new AASpawnEggItem(AAEntities.GUINEA_CHICKEN, 0x2c2826, 0xdee0ca, new Item.Properties().tab(GROUP)));
}