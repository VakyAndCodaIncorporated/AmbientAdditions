...
public class AAItems {
    ...
    public static final RegistryObject<Item> RING_TAILED_LEMUR_SPAWN_EGG = REGISTER.register("ring_tailed_lemur_spawn_egg", () -> new AASpawnEggItem(AAEntities.RING_TAILED_LEMUR, 0x544e4a, 0x6b6661, new Item.Properties().tab(GROUP)));
