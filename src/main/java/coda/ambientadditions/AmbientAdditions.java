...
public class AmbientAdditions {
    ...
    private void spawnPlacements(SpawnPlacementRegisterEvent e) {
        ...
        e.register(AAEntities.GOLDEN_ELEPHANT_SNAIL.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING, GoldenElephantSnailEntity::checkSnailSpawnRules, SpawnPlacementRegisterEvent.Operation.AND);
