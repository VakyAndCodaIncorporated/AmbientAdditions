...
public class SiamangGibbonModel<T extends SiamangGibbonEntity> extends AgeableModel<T> {
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.head.y = MathHelper.cos(-1.0F + limbSwing * speed * 0.4F) * degree * 0.05F * limbSwingAmount - 4.45F;
        ...
        this.right_arm.y = limbSwingAmount - 2.45F;
        this.left_arm.y = limbSwingAmount - 2.45F;
        this.throat_pouch.y = MathHelper.cos(-2.0F + limbSwing * speed * 0.4F) * degree * 0.05F * limbSwingAmount - 3.98F;
