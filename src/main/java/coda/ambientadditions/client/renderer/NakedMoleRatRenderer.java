...
public class NakedMoleRatRenderer extends GeoEntityRenderer<NakedMoleRatEntity> {
    ...
    @Override
    public RenderType getRenderType(NakedMoleRatEntity animatable, float partialTicks, PoseStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
