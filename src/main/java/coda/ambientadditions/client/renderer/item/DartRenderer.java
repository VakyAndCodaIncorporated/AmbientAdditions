...
public class DartRenderer extends EntityRenderer<DartEntity> {
    ...
    public DartRenderer(EntityRendererManager p_i46193_1_) {
        super(p_i46193_1_);
    }
    ...
    @Override
    public void render(DartEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
