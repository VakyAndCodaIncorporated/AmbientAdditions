...
public class YetiCrabRenderer extends GeoEntityRenderer<YetiCrabEntity> {
    ...
    @Override
    public RenderType getRenderType(YetiCrabEntity animatable, float partialTicks, PoseStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
