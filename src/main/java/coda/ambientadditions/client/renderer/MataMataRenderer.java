...
public class MataMataRenderer extends GenericGeoRenderer<MataMataEntity> {
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, MataMataEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
