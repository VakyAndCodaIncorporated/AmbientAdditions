...
public class SpiderTailedAdderRenderer extends GeoEntityRenderer<SpiderTailedAdderEntity> {
    ...
    @Override
    public RenderType getRenderType(SpiderTailedAdderEntity animatable, float partialTicks, PoseStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
