...
@OnlyIn(Dist.CLIENT)
public class PembrokeCorgiCollarLayer extends LayerRenderer<PembrokeCorgiEntity, PembrokeCorgiModel<PembrokeCorgiEntity>> {
   ...
   public PembrokeCorgiCollarLayer(IEntityRenderer<PembrokeCorgiEntity, PembrokeCorgiModel<PembrokeCorgiEntity>> p_i50914_1_) {
      super(p_i50914_1_);
   }

   public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, PembrokeCorgiEntity p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
