...
public class DuckyMaskModel<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public DuckyMaskModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mask = field_78116_c.addOrReplaceChild("mask", CubeListBuilder.create().texOffs(64, 8).addBox(-4.5F, -8.5F, -4.5F, 9.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition band = mask.addOrReplaceChild("band", CubeListBuilder.create().texOffs(64, 0).addBox(-4.5F, -3.5F, -3.5F, 9.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 1.0F));

		PartDefinition bill = mask.addOrReplaceChild("bill", CubeListBuilder.create().texOffs(64, 19).addBox(-2.5F, -2.5F, -6.5F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		.texOffs(64, 0).addBox(-4.5F, -27.5F, -2.5F, 9.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(64, 19).addBox(-2.5F, -26.5F, -6.5F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(64, 8).addBox(-4.5F, -32.5F, -4.5F, 9.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(16, 48).addBox(-3.9F, -12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		field_78116_c.render(poseStack, buffer, packedLight, packedOverlay);
